...
const deleteMealAndOrder = (mealDeleted) => {
    ...
    fetch('https://serverless.aalvarez75gih.vercel.app/api/orders') //1
            ...
            .then(r => {
                const template = r.map(t => {
                    ...
                    if (meal_deleated === mealOn_Order){
                        ...
                        fetch('https://serverless.aalvarez75gih.vercel.app/api/orders/' + id_order, { //fetch para eliminar meals
                        method:'delete',
                        headers:{
...
//     const meal_deleated = mealDeleted
    // console.log('comida que fue borrada: ', meal_deleated)
    // console.log('1. Important: If there are orders related with that meal they will be removed from database')
    // fetch('https://serverless.aalvarez75gih.vercel.app/api/orders') //1
    //         .then(response => response.json()) //2
    //         .then(r => {
    //             const template = r.map(t => {
    //                 mealOn_Order = t.meal_id
    //                 if (meal_deleated === mealOn_Order){
    //                     console.log('Some orders will be deleted')
    //                     const id_order = t._id
    //                     fetch('https://serverless.aalvarez75gih.vercel.app/api/orders/' + id_order, { //fetch para eliminar meals
    //                     method:'delete',
    //                     headers:{
    ...
    //                     },
    //                 })
                    // .then(x => console.log('orders have been deleted'))         
    //             }else{
    //             console.log('There are no orders containing that meal ')
    ...
    //     console.log('5.hey lo logre')
    //     // renderOrders()
    //     console.log('6. esto debe ser el final')
...
const renderMeal = () => {
    ...
    sendMealBtn.addEventListener("click" , () =>{
        ...
        fetch('https://serverless.aalvarez75gih.vercel.app/api/meals',{
            method:'POST',
            headers:{
                'Content-Type': 'application/json',
                authorization: token,
...
const deleteMeal = () => {
    ...
    fetch('https://serverless.aalvarez75gih.vercel.app/api/meals/' + meal_id, { //fetch para eliminar meals
            method:'delete',
            headers:{
                'Content-Type': 'application/json',
                authorization: token,
...
const renderData = () => {
    ...
    // fetch para hacer Post de ordenes
        fetch('https://serverless.aalvarez75gih.vercel.app/api/orders',{ //33
            method:'POST',
            headers:{
                'Content-Type': 'application/json',
                authorization: token,
        ...
        .then(respuesta => {
            ...
            fetch('https://serverless.aalvarez75gih.vercel.app/api/backup',{ //33
            method:'POST',
            headers:{
                'Content-Type': 'application/json',
                authorization: token,
...
const renderRegister = () =>{
    ...
    registerForm.onsubmit = (e) => {
        ...
        fetch('https://serverless.aalvarez75gih.vercel.app/api/users/register',{ //33
            method:'POST',
            headers:{
            'Content-Type': 'application/json',
        },
...
const renderLogin = () =>{
    ...
    loginForm.onsubmit = (e) => {
        ...
        fetch('https://serverless.aalvarez75gih.vercel.app/api/auth/login', {
            ...
            .then(token => {
                return fetch('https://serverless.aalvarez75gih.vercel.app/api/auth/me',{
                    method:'GET',
                    headers: {
                    'Content-Type': 'application/json',
                    authorization: token,
